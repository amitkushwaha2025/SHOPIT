...
import { getProductDetails, newReview, clearErrors, getCategoryProducts } from '../../actions/productActions'
...
const ProductDetails = () => {
    ...
    }, [dispatch, alert, error, category, reviewError, id, success])
    ...
    const randomProducts = products ? shuffleArray([...products]).slice(0, 4) : [];
            ...
            {loading ? <Loader /> : (
                <Fragment>
                    ...
                    <section id="products" class="container mt-2">
                        <h3>Get instant recommendations:</h3>
                        <hr />
                        <div class="row">
